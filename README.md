...
พิมพ์ปัญหาตามด้วย **(ช่วยคิด)** แล้วให้ AI agent อ่าน skill นี้:

### ลังเลเรื่องอาชีพ

```
อ่าน zecision/SKILL.md แล้วช่วยคิด
ผมกำลังลังเลระหว่างลาออกกับอยู่ต่อ ที่เดิม toxic แต่เงินดี
ควรตัดสินใจยังไง?
```
...
```
อ่าน zecision/SKILL.md แล้วช่วยคิด
จะเลือกเรียนต่อ ป.โท หรือ เริ่มธุรกิจของตัวเองดี
...
```
อ่าน zecision/SKILL.md แล้วช่วยคิด
แฟนอยากย้ายไปอยู่ด้วยกัน แต่ผมเพิ่งเริ่มงานใหม่
...
```
อ่าน zecision/SKILL.md แล้วช่วยคิด
มีเงินก้อน 1 ล้าน ควรดาวน์คอนโด หรือลงทุนกองทุนรวมดี
...
```bash
git clone https://github.com/hartkitsak/zecision.git
```

แล้วบอก AI agent ว่า:

```
อ่าน zecision/SKILL.md แล้วช่วยคิด[สถานการณ์ของคุณ]
```
